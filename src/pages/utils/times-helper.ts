...
import { Times } from "pages/api/azure-function/coordinates/coordinates-api-client/coordinates-api-response-schema";
import { WeatherIconList } from "ui-kit/weather-svg-ref/weather-icon-list";

export const timesAheadOfNow = (times: Times[]): Times[] => {
